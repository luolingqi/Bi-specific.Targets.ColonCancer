...
runtime: shiny
resource_files:
- Picture_positivity_10TPM.cutoff.png
---
...
```{r cache=TRUE, results=FALSE, echo=FALSE}
...
```{r histogram, echo=FALSE, fig.width = 18, fig.height = 10}
...
inputPanel(
  selectInput("genePair", label = "Select the pair of genes:",
              choices = paste(df_pairs$V1,df_pairs$V2,sep = "_vs_"), selected = "CDH11_vs_MET"),
		 sliderInput("n", "Bins", 30, 100, 50)
)

renderPlot({
  #drawExpHist(unlist(strsplit(input$genePair, "_vs_")))
